...
<div class="container sans my-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg4 tx1">{{ __('Register') }}</div>
                ...
                <div class="card-body bg5">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="Re-type new password" required autocomplete="new-password">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control" name="username" placeholder="Enter username" required autocomplete="username">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="gender" type="text" class="form-control" name="gender" placeholder="Male/Female" required autocomplete="gender">
                            </div>
                        </div>
