    ...
    <div class="col-lg-10 col-md-9 col-8">
        <div class="card bg5">
            ...
            <div class="card-body sans tx3 pt-0">
              <div class="row">
                <div class="col-7">
                <h2 id = "title"><strong></strong></h2>
                <p class="text-muted text-sm" id="description"></p>
                </div>
                          ...
                          <div class="row mt-2">
                              <div class="text-center col-12 my-auto">
                                  <div class="icon my-auto row">
                                      ...
                                      <img class="border rounded-circle mx-auto" src="{{url('img/profile.png')}}" width="40" height="40">
